        ...
        protected override void OnEndManipulation(TapGesture gesture)
        {
                ...
                gesture.StartPosition.x, gesture.StartPosition.y, raycastFilter, out hit))
            {
                ...
                else if (spawn == false)
                {
                    ...
                    var andyObject = AndyPrefab;
                    if (!AndyPrefab.activeInHierarchy)
                    {
                        AndyPrefab.SetActive(true);
                        AndyPrefab.transform.position = hit.Pose.position;
                        AndyPrefab.transform.rotation = hit.Pose.rotation;
